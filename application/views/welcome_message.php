...
<head>
	<meta charset="utf-8">
	<title>Welcome to use i2cc's API</title>
...
<div id="container">
	...
	<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds. <?php echo  (ENVIRONMENT === 'development') ?  'i2CC\'s API Version <strong>' . '</strong>' : '' ?></p>
</div>
